import os
from dataset import Dataset_for_primary_tumor
...
save_dir = 'trained_models/primary_tumor/bs{}_epoch{}_seed{}'.format(args.bs, args.epoch, args.seed)
...
train_data = Dataset_for_primary_tumor(data_dir, train_split_path, metadata_path, augment=True)
val_data = Dataset_for_primary_tumor(data_dir, val_split_path, metadata_path, augment=False)
...
print('train_lenth: %i  val_lenth: %i  num_0: %i  num_1: %i  num_2: %i' % (
    train_data.len, val_data.len, train_data.num_0, train_data.num_1, train_data.num_2))
